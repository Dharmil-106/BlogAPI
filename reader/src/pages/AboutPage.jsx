...
export default function AboutPage() {
  ...
  if (loading) {
    return (
      <div className="about-page container loading-container">
          ...
          {profile?.projectLinks?.length > 0 ? (
            profile.projectLinks.map((project, index) => (
              ...
              >
                ...
                <span className="about-page__project-name">{project.name}</span>
                <span className="about-page__project-desc">{project.description}</span>
              </a>
            ))
          ) : (
